namespace RACQAZWEBAPI.Channel.CMO.NominationMgmt.v1.API
{
    ...
    using RACQAZ.Channel.CMO.NominationMgmt.v1.API.OperationFilters;
    ...
    public static class CustomServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddCustomOptions(
            ...
            //.AddTransient<IConfigureOptions<AzureAdOptions>, ConfigureAzureAdOptions>()
            .AddTransient<IConfigureOptions<PartyMatchManagementAuthOptions>, ConfigurePartyMatchManagementAuthOptions>()
            .AddTransient<IConfigureOptions<ServiceBusAuthOptions>, ConfigureServiceBusOptionsAuthOptions>()
            .AddTransient<IConfigureOptions<PartyManagementAuthOptions>, ConfigurePartyManagementAuthOptions>()
            .AddTransient<IConfigureOptions<QuoteManagementAuthOptions>, ConfigureQuoteManagementAuthOptions>()
            .AddTransient<IConfigureOptions<CartManagementAuthOptions>, ConfigureCartManagementAuthOptions>()
            // ConfigureSingleton registers IOptions<T> and also T as a singleton to the services collection.
            ...
            .ConfigureAndValidateSingleton<PartyMatchManagementAuthOptions>(configuration.GetSection(nameof(ApplicationOptions.PartyMatchManagementAuth)))
            .ConfigureAndValidateSingleton<PartyMatchManagementOptions>(configuration.GetSection(nameof(ApplicationOptions.PartyMatchManagement)))
            .ConfigureAndValidateSingleton<PartyManagementAuthOptions>(configuration.GetSection(nameof(ApplicationOptions.PartyManagementAuth)))
            .ConfigureAndValidateSingleton<PartyManagementOptions>(configuration.GetSection(nameof(ApplicationOptions.PartyManagement)))
            .ConfigureAndValidateSingleton<QuoteManagementOptions>(configuration.GetSection(nameof(ApplicationOptions.QuoteManagement)))
            .ConfigureAndValidateSingleton<QuoteManagementAuthOptions>(configuration.GetSection(nameof(ApplicationOptions.QuoteManagementAuth)))
            .ConfigureAndValidateSingleton<CartManagementAuthOptions>(configuration.GetSection(nameof(ApplicationOptions.CartManagementAuth)))
            .ConfigureAndValidateSingleton<CartManagementOptions>(configuration.GetSection(nameof(ApplicationOptions.CartManagement)))
            .ConfigureAndValidateSingleton<ServiceBusAuthOptions>(configuration.GetSection(nameof(ApplicationOptions.ServiceBusAuth)))
            ;
        ...
        public static IServiceCollection AddCustomSwagger(this IServiceCollection services) =>
            services.AddSwaggerGen(
                options =>
                {
                    ...
                    _ = options.IncludeXmlCommentsIfExists(assembly);
